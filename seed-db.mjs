...
async function seedDatabase() {
  ...
  try {
    ...
    await connection.execute("INSERT INTO users (openId, username, passwordHash, name, email, phone, address, loginMethod, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE username = VALUES(username), passwordHash = VALUES(passwordHash), name = VALUES(name), email = VALUES(email), role = VALUES(role)", ["demo-admin", "admin", "scrypt:136c59f1921d04fcf2c7001a6449e734:f552bfd330b14dd20e8a64a39964dd63030906b4bba15c37561ebdf1d2969d646ea69bab1206a349347e57d53b8ddbb0883b47a129b6e86cd8a70982b50d7bc7", "مدير عام", "admin@example.com", "0500000000", "الرياض - حي تجريبي", "seed", "admin"]);

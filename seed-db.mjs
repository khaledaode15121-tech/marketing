...
async function seedDatabase() {
  ...
  try {
    ...
    await connection.execute("INSERT INTO users (openId, username, passwordHash, name, email, phone, address, loginMethod, role) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ON DUPLICATE KEY UPDATE username = VALUES(username), passwordHash = VALUES(passwordHash), name = VALUES(name), email = VALUES(email), role = VALUES(role)", ["demo-admin", "admin", "scrypt:e5bb3a2b3dbee63315eb3c865b00001d:bf271e6fe22bb70d260171789e6eec8a81acaaa64c39b90f1955f461a33162c901e5e7ccfaafb31a75cd6743eb0fc166bb300818b6290c7b709306038e9e7290", "مدير عام", "admin@example.com", "0500000000", "الرياض - حي تجريبي", "seed", "admin"]);
